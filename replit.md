...
*   **Recruiting QoL**: Includes sorting options, a "Next Year Roster Forecast," personal notes, filter presets, and a comparison tool for up to three recruits.
...
*   **Season Structure**: Progresses through phases: Preseason, Spring Training, Recruiting, Regular Season, Super Regionals, CWS, and Offseason, with a weekly advance system.
