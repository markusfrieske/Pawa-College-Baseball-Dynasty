  ...
  injury_risk: {
    ...
    events: [
      ...
      },
      {
        ...
        choiceA: "Get him a third opinion — on {team}'s dime, no strings, just information", choiceAOutcome: "The offer of independent information with no agenda signals that you're solving his problem, not yours. He calls the next morning.", choiceAWeights: W.bold_pos,
    ...
    events: [
      {
        ...
        eventText: "{name} scored a 34 on the ACT. He speaks three languages. He built a working weather prediction model for a science fair and won by 40 points. His GPA is a 2.4 because he refuses to do homework for teachers he considers intellectually dishonest. His high school coach told you privately: 'He will fail out of {team} in one semester unless you give him room to breathe. But he can play. God, he can play.'",
  ...
  the_two_sport_icon: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "{name} calls you at 6am. Before you can say anything, he says: 'I've decided. Baseball. {team}.' He says {team} was the only one that made him feel like a baseball player and not a contract negotiation. Then he says: 'I haven't told my agent yet. Or my football coaches. I'm telling you first.' He pauses. 'I need you to not make a big deal about this right now.'",
...
export function generateStorylineEvent(
  ...
  const interpolate = (text: string) => {
    const team = teamName ?? "the program";
    let out = text
