  ...
  late_bloomer: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "{name} posted a workout clip at 11pm on a Wednesday. By 6am his father was calling programs: 'I don't know what's happening. Can someone call us today?' The clip has 38 million views. He looks completely different from the player scouts first evaluated. Programs have twelve hours before the noise makes a real conversation impossible.",
    ...
    events: [
      {
        ...
        choiceC: "Invite him for a private bullpen with {team}'s pitching staff next week", choiceCOutcome: "The controlled environment shows you a full picture — including whether the command issues are fixable.", choiceCWeights: W.neutral_up,
      ...
      },
      {
        ...
        eventText: "A sports science firm called Apex Kinematics has offered to train {name} for free — and wants unlimited biometric access to his arm in exchange. They believe his shoulder rotation speed may be physically anomalous. He's 17. His parents are reaching out to one trusted program for an opinion. No other program has been consulted.",
      ...
      },
      {
        ...
        eventText: "{name} touched 104 at the state showcase — the gun didn't break this time — retired nine straight batters, then tried his first curveball and it sailed over the backstop into the stands. A woman in the third row had to duck. Two scouts burst out laughing. One of them was crying at the same time. That's the range of outcomes with this arm. The window for a serious move is 48 hours.",
        ...
        choiceC: "Connect him with a former first-rounder from {team} who went through the same thing", choiceCOutcome: "The peer mentor story of a raw arm becoming a pro is exactly the narrative he needs right now.", choiceCWeights: W.bold_pos,
    ...
    events: [
      {
        ...
        choiceC: "Send him footage of {team}'s best hitters — show him what's possible here", choiceCOutcome: "The developmental vision you paint alongside the rebuild creates a compelling future picture.", choiceCWeights: W.neutral_up,
      ...
      },
      {
        ...
        choiceA: "Invite him for an official visit immediately — capitalize on the momentum", choiceAOutcome: "The timing of the visit amid his surge makes {team} feel like part of the breakthrough story.", choiceAWeights: W.high_risk,
  ...
  position_change: {
    ...
    events: [
      ...
      },
      {
        ...
        choiceB: "Arrange for him to work with {team}'s catcher development coach", choiceBOutcome: "Putting elite positional resources in front of him makes the vision tangible.", choiceBWeights: W.safe_pos,
  ...
  summer_breakout: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "{name} is 2-for-18 in fall ball against real competition and visibly pressing. The agent has stopped responding to scout emails. Two programs quietly rescinded their offers without explanation. His father reached out at midnight: 'He's not sleeping. He thinks he fooled everyone this summer and now they know. Can someone call him?'",
    ...
    events: [
      {
        ...
        eventText: "{name} has 4.2 million followers and his latest training clip hit 40 million views in three days — more than any MLB player's content this week. Gatorade, Nike, and a fast food chain all called on the same afternoon. He was supposed to be at a key showcase that weekend. He wasn't there. His high school coach called programs, not to complain — to ask for advice.",
        ...
        choiceC: "Connect him with a current player at {team} who navigated early fame", choiceCOutcome: "Peer testimony from someone who's lived it and came through it is more useful than anything a coach can say.", choiceCWeights: W.safe_pos,
      ...
      },
      {
        ...
        eventText: "A DM {name} sent two years ago — at 15 years old — surfaces on social media. It's ambiguous but the context is gone and the framing is brutal. Three programs rescinded their offers without calling first. His mother reached out to one program, voice breaking: 'You're the only one who hasn't taken it back. Is that still true?'",
        ...
        choiceC: "Pull back for now — {team}'s reputation has to be protected first", choiceCOutcome: "The decision to protect the program over the person is remembered. By him. By his mother. By everyone watching.", choiceCWeights: W.risky_neg,
      },
    ],
  },
    ...
    events: [
      {
        ...
        eventText: "{name}'s father built a batting cage in their backyard when he was six years old and coached him every single day for twelve years. He passed away in October. {name} still shows up to every practice. He still takes every at-bat. He just hasn't had a hit since the funeral, and every scout who sees him says the same thing: 'Something's gone.' The question facing any evaluator: is what's gone something a program can help restore, or is it something only time can reach?",
        eventTextPitcher: "{name}'s father built a pitching mound in their backyard when he was six years old and coached him every single day for twelve years. He passed away in October. {name} still shows up to every bullpen session. He still takes the mound for every start. He just hasn't thrown a clean inning since the funeral — walked 14 in his last two outings — and every scout who sees him says the same thing: 'Something's gone.' The question facing any evaluator: is what's gone fixable with mechanics, or is it something deeper?",
      ...
      },
      {
        ...
        eventText: "{name} hit a walk-off in a meaningless fall scrimmage and sobbed in the dugout for ten minutes afterward while his teammates celebrated without him. His teammate told coaches afterward: 'He said it was the first time he felt anything at the plate since his dad died.' Two scouts in the stands saw it. One of them started calling programs right after. The other one was crying and couldn't talk yet.",
        eventTextPitcher: "{name} struck out the side in a meaningless fall scrimmage and sobbed in the dugout for ten minutes afterward while his teammates celebrated without him. His teammate told coaches afterward: 'He said it was the first time he felt anything on the mound since his dad died.' Two scouts in the stands saw it. One of them started calling programs right after. The other one was crying and couldn't talk yet.",
      ...
      },
      {
        ...
        eventText: "{name} stepped into the batter's box in the seventh inning last Friday and looked different. Not physically — his stance. Loose. Present. The thing he lost in October was suddenly, improbably back. He hit a line drive to left center. Jogged to second. Stood there looking at the sky for a moment before anyone could make sense of what they'd just seen. His high school coach reached out afterward: 'He's coming back. The right programs should know.'",
        eventTextPitcher: "{name} stepped onto the mound in the seventh inning last Friday and looked different. Not physically — his grip, his set, his exhale before the wind-up. The thing he lost in October was suddenly, improbably back. He struck out the side on nine pitches. Walked to the dugout without a word. His high school coach reached out afterward: 'He's coming back. The right programs should know.'",
  ...
  burnout_candidate: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "{name} didn't show up to a major showcase — a $2,000 event his family already paid for. His high school coach says he's 'unavailable.' His Instagram shows him fishing at a lake 200 miles away. He texted coaching staffs at midnight: 'Sorry coach. I needed to breathe. I'll understand if this changes things.' He apologized to programs for needing rest — the only recruit in recent memory to do so.",
      ...
      },
      {
        ...
        eventText: "{name} reached out to one program in December. It was the first call he'd initiated in six months. He said: 'I think I needed to remember why I started. I went home, hit in my dad's gym for a week. Nobody watching. No showcases. I figured something out.' He paused. 'I'm ready to make a decision. But I wanted to reach out first, before talking to anyone else.' He sounds different — quieter and more certain at the same time.",
        eventTextPitcher: "{name} reached out to one program in December. It was the first call he'd initiated in six months. He said: 'I think I needed to remember why I started. I went home, threw in my dad's garage for a week. Nobody watching. No radar gun. I figured something out.' He paused. 'I'm ready to make a decision. But I wanted to reach out first, before talking to anyone else.' He sounds different — quieter and more certain at the same time.",
    ...
    events: [
      {
        ...
        choiceA: "Call him tonight — name exactly what 91 on a changeup grip means to evaluators of his arm", choiceAOutcome: "Naming the significance of what he just did — in technical terms — shows genuine understanding of what happened. He's never heard that from a coach.", choiceAWeights: W.bold_pos,
        ...
        choiceC: "Offer to cover an independent evaluation with {team}'s medical staff", choiceCOutcome: "Investing in his health before you've made him a player signals that you see him as a person first.", choiceCWeights: W.neutral_up,
      ...
      },
      {
        ...
        eventText: "The medical news on {name} came back ambiguous. One surgeon recommends shutting the arm down for eight months. Another says there's no structural reason he can't pitch through it with careful management. Two programs quietly withdrew. Four others are waiting. He confided to one coaching staff what neither surgeon said: 'I feel fine. I just don't know who to trust anymore.'",
        choiceA: "Get him a third opinion — on the program's dime, no strings, just information", choiceAOutcome: "The offer of independent information with no agenda signals that the program is solving his problem, not its own. He calls the next morning.", choiceAWeights: W.bold_pos,
        choiceB: "Give a direct answer on what the evidence suggests — skip the coaching spin and be honest about the risk", choiceBOutcome: "The direct answer, not the safe coaching answer, is something he wasn't expecting. It becomes the conversation he references when he announces his decision.", choiceBWeights: W.safe_pos,
    ...
    events: [
      {
        ...
        eventText: "{name} scored a 34 on the ACT. He speaks three languages. He built a working weather prediction model for a science fair and won by 40 points. His GPA is a 2.4 because he refuses to do homework for teachers he considers intellectually dishonest. His high school coach pulled one coaching staff aside: 'He will fail out of somewhere in one semester unless he gets room to breathe. But he can play. God, he can play.'",
        ...
        choiceB: "Connect him with students at {team} who share his mindset", choiceBOutcome: "Peer examples of people who found their place — academically and athletically — make the vision real.", choiceBWeights: W.safe_pos,
      ...
      },
      {
        ...
        eventText: "{name} cleared eligibility — barely. Then he sent his three finalist schools a 4-page letter organized like a legal brief explaining his decision criteria. With citations. {team} made the list. His postscript reads: 'I will require academic latitude. I do not do mediocre work. I hope that is compatible with {team}'s culture.' Each program has one chance to answer correctly.",
      ...
      },
      {
        ...
        eventText: "{name} cleared full academic eligibility — just barely, again, but this time without any asterisks. His advisor sent a letter. His mother framed it. He sent one program the photo of the framed letter with one line: 'It's real now.' He hasn't responded to eleven coaches who reached out since the news broke. That program's message was the twelfth. He responded to that one.",
  ...
  transfer_rumors: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "{name} reached out to one program at 10:14pm on a Wednesday. One message: 'Can we talk tomorrow? Just you and me. No handlers.' The handler doesn't know. The rival programs don't know. His family doesn't know. One program has a window nobody else has been offered. Tomorrow morning there are formal commitment meetings scheduled with two other schools.",
  ...
  two_sport_athlete: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "ESPN ran a full feature on {name}. It was about football. Baseball was mentioned once, in a scrolling chyron. He reached out to one baseball program that night — the first time he'd ever initiated contact — and wrote: 'I didn't love how that came out. Can we talk?' Whether this is the moment or just a moment, the reach-out was unprompted.",
      ...
      },
      {
        ...
        eventText: "{name}'s football coach called a private meeting. Nobody outside the two of them knows what was said. What happened after: {name} reached out to one program within the hour. The message was two lines: 'I've made my decision. Baseball. I need you to trust that I'm sure.' He didn't say what was said in that room. He didn't owe that. He offered the outcome instead.",
        choiceA: "Tell him you trust him and ask one thing: what he needs from you right now", choiceAOutcome: "The immediate pivot to 'what do you need' before anything about {team} signals that you understand what he actually went through.", choiceAWeights: W.bold_pos,
  ...
  knuckleball_specialist: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "The high school coach who built {name}'s entire development around the knuckleball retired in December. The new coach held a team meeting in January and said the words: 'We're running a conventional program now.' {name} is 17, his identity is the knuckleball, and the one adult who understood what he was doing just left the building. He called one coaching staff the night of the meeting. Not much was said on either end. But he stayed on the phone for 45 minutes.",
        choiceA: "Offer {team}'s pitching staff as his new development home — make {team} the place the knuckleball gets built", choiceAOutcome: "Positioning {team}'s staff as the successor to his mentor fills the gap in a way no other program can claim. He commits before the spring.", choiceAWeights: W.bold_pos,
        ...
        choiceC: "Invite him to {team}'s campus to throw — let him feel what it's like to be surrounded by coaches who don't flinch", choiceCOutcome: "The visit is the first time he's thrown the knuckleball for coaches who leaned in instead of looking away. He cries in the parking lot after.", choiceCWeights: W.neutral_up,
      },
    ],
  },
  ...
  rivalry_recruit: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "{name} made his decision known. He's choosing {team}. He grew up in their city, wore their gear, his father played there — and he's choosing {team}. He has one request before announcing: 'Don't make me into a story about them. Let me be a story about {team}.' He's been carrying this for three months. He's about to face the fallout. He just needs to know someone sees who he actually is.",
    ...
    events: [
      {
        ...
        eventText: "Word came through back channels that {name} had narrowed to two schools. The next morning at 5:58am, a national outlet broke the story — and got it wrong. They said he'd already committed to the rival. The story has been shared 80,000 times. {name} has not posted. His family isn't answering calls. His coach says he's 'unavailable.' One program has a relationship — but the whole country is flooding that same channel right now.",
      ...
      },
      {
        ...
        eventText: "A scout who has been doing this for 38 years pulled a coach aside after a {name} workout and said very quietly: 'I've seen exactly one player like this in my entire career. The other one is in the Hall of Fame.' He said it once, packed up his radar gun, and left without writing anything down. {name} is choosing between five programs at the end of this week. Each has one more scheduled conversation.",
      ...
      },
      {
        ...
        eventText: "Commitment day. {name} has narrowed to two schools. His mother called with 58 minutes left. Her voice was steady. She said: 'Every coach has told us about their program. Tell me something no coach has said. About my son.' There's no prepared answer for this. The program's response is the real closing argument.",
    ...
    events: [
      {
        ...
        eventText: "{name} was the consensus #1 recruit in his region six months ago. Then something happened. His old program went completely silent. His ranking evaporated. He stopped showing up at showcases. No statement, no explanation, nothing. Rumors are everywhere and none of them agree. Two coaches who know his family have called programs separately — neither one knew the other called — and both said exactly the same thing: 'Someone needs to show up. Not call. Show up.'",
      ...
      },
      {
        ...
        eventText: "{name} finally opened up to one coaching staff. Not about baseball. About what actually happened. It takes an hour. When he's done, he's quiet for a moment, and then he says: 'Every program that's still recruiting me is doing it because they think I'll bounce back. I need someone who'd still be here if I don't.' The coaches who backed off are now calling again because his numbers are improving.",
      ...
      },
      {
        ...
        eventText: "{name} is back on the field. His numbers are trending up. His grades are recovering. The programs that distanced themselves are now calling again — the same ones that didn't return his father's calls three months ago. He told one coaching staff: 'You were the only program that didn't ghost me.' He's ready to make a decision. The programs that stayed are the obvious candidates. But he's going to make them work for it anyway, because he's earned the right to.",
    ...
    events: [
      {
        ...
        eventText: "An NFL general manager flew to {name}'s high school game on a private jet — announced nothing, just showed up. {name} has a certified agent at 17. He is projected as a top-15 NFL pick and a top-5 MLB Draft pick by two separate outlets. ESPN is arriving Thursday. One program also has a meeting scheduled Thursday — the one arranged three weeks ago, before any of this existed. That program gets one hour with him before the cameras arrive.",
      ...
      },
      {
        ...
        eventText: "{name} called one program at 6am. Before anything else, he said: 'I've decided. Baseball. The program.' He said the program was the only one that made him feel like a baseball player and not a contract negotiation. Then: 'I haven't told my agent yet. Or my football coaches. This is my first call.' He paused. 'I need this kept quiet right now.'",
  ...
  the_scientist: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "{name} has sent a pre-call agenda for a 90-minute scheduled conversation. It is color-coded. It is time-stamped. Topics include 'Spin Rate Development Philosophy,' 'Exit Velocity Improvement Rate by Position over 5 Years,' and 'Program Culture as a Data Variable.' One program's analytics coach is at a wedding in Savannah and unreachable. The call starts in 11 minutes.",
      ...
      },
      {
        ...
        eventText: "{name} has completed his analysis. He's chosen three finalists. {team} is one of them. His final question — sent to all three by email, at the same time, timestamped 9:14am — reads: 'What is one decision you would make differently about {team} if you had access to perfect information from the beginning? I am not looking for a strategic answer. I am looking for an honest one.' Two other programs have already responded. He's shared their answers with all three finalists, without naming who said what. One was political. One hung up.",
        ...
        choiceB: "Turn it back to him — ask what his model would change about {team}, and engage with the answer", choiceBOutcome: "Making his analysis part of the actual program conversation transforms the relationship from evaluation to collaboration. He wasn't expecting that.", choiceBWeights: W.neutral_up,
  ...
  folk_hero: {
    ...
    events: [
      ...
      },
      {
        ...
        choiceB: "Invite him for a quiet private visit — no media, no fanfare, no event around it", choiceBOutcome: "The quiet visit is the demonstration that {team} understands what he was asking for. The visit goes long.", choiceBWeights: W.safe_pos,
      ...
      },
      {
        ...
        eventText: "{name} announces his commitment in his high school gymnasium. The room holds 400. 800 people show up. Another hundred watch through the windows from outside. He stands at the podium for a long moment before speaking, looks toward a coach in the corner of the room, and says: 'I picked the school that felt like home.' The town erupts. One program gained not just a player — but a story that will travel for a generation.",
        choiceA: "Invite the town — arrange for his community to visit {team} early in the season", choiceAOutcome: "Bringing his world into yours is an act of respect that defines the relationship permanently. He talks about it every time someone asks why he chose {team}.", choiceAWeights: W.bold_pos,
        choiceB: "Give him the platform — let him represent where he came from in everything {team} does", choiceBOutcome: "Making him an ambassador for his own story gives him something bigger than baseball to carry. He thrives.", choiceBWeights: W.safe_pos,
    ...
    events: [
      {
        ...
        choiceC: "Offer a sanctuary — pitch {team} as the place where he can be a baseball player, not a brand", choiceCOutcome: "The specific framing of 'just being a baseball player' is something nobody in his orbit has offered him. He's been waiting for it.", choiceCWeights: W.neutral_up,
      ...
      },
      {
        ...
        eventText: "A national outlet projects {name} as a top-3 MLB Draft pick after one year of college. He calls one program the morning it publishes and says: 'I don't want to talk about that. Can we talk about the program instead?' Whether it is a test or performed indifference, what is known: he called at 7am and his manager doesn't know about the call.",
        ...
        choiceC: "Build a one-year plan — show him specifically how {team} maximizes a one-year showcase", choiceCOutcome: "The concrete one-year plan signals you understand and support his professional trajectory without pretending it's anything else.", choiceCWeights: W.neutral_up,
        choiceD: "Make the biggest NIL offer in {team}'s history — show him you understand what he's worth", choiceDOutcome: "The offer registers as noise in a conversation that was about something else entirely. He wraps up the call shortly after.", choiceDWeights: W.high_risk,
      },
      {
        id: "gp_3",
        ...
        eventText: "The night before {name}'s commitment announcement, his manager calls one program — not the family, the manager — and says the player has one final question to answer before morning. The question: 'When he struggles — not if, when — what exactly happens? What do you actually do?' The manager says five programs have been asked this question. Three gave PR answers. One said it was an unusual question. This is the fifth call.",
        choiceA: "Give the specific, concrete answer — name exactly what happens, step by step, when a player struggles at {team}", choiceAOutcome: "The operational specificity is the answer to the question everyone else avoided. He commits before the manager gets off the phone.", choiceAWeights: W.bold_pos,
        ...
        choiceC: "Name a current player who struggled and what happened next — let the evidence speak", choiceCOutcome: "The concrete example of what happened to a real person at {team} is the most credible version of the answer possible.", choiceCWeights: W.neutral_up,
      },
    ],
    legendaryEvents: [
      {
        ...
        choiceC: "Declare publicly that this is the most important recruit in {team}'s history", choiceCOutcome: "The public declaration is bold. He sees it. He either loves the weight of it or feels the pressure of it. No way to know which until it's done.", choiceCWeights: W.high_risk,
      },
    ],
  },
    ...
    events: [
      {
        ...
        eventText: "{name}'s father works double shifts. His mother asked one coaching staff — directly, the first time she spoke — whether the scholarship covers books. His family has never watched a college game in person. He's never flown on a plane. He told one coaching staff all of this quietly, like it was something he was confessing. He can play. Everyone can see that. The question nobody has thought to answer is whether someone will make this actually possible.",
      ...
      },
      {
        ...
        eventText: "A rival program offered {name} a full scholarship plus a $12,000 NIL package his first year — more money than anyone in his family has ever been offered for anything. He texted the number to one program. Not to negotiate. He texted it because he needed an honest answer: is it enough to say yes to a program he doesn't love as much? He's waiting.",
        ...
        choiceC: "Tell him the rival's offer is real and fair and ask what would make {team} worth the difference to him", choiceCOutcome: "Acknowledging the rival's offer without panic or politics earns a respect no competing bid can replicate.", choiceCWeights: W.neutral_up,
      },
      {
        id: "fp_3",
        ...
        eventText: "The scholarship letter arrived. His mother called one program before {name} did. She said three words: 'We can do this.' Then she passed the phone to his father, who said: 'Thank you for explaining it the way you did.' Then she got back on and said: 'He wants to come. He just doesn't know how to say it yet.' {name} gets on the phone ten seconds later and says: 'I'm in.' He says it the way people say things they've been rehearsing for months.",
    ...
    events: [
      {
        ...
        eventText: "{name}'s high school coach — the man who found him, built his mechanics, made the call to three college programs that started everything — retired in March. He didn't announce it. He told the players first, then their parents, then sent one email to coaches he trusted. {name} hasn't spoken publicly. He pulled out of two scheduled showcases. He told an assistant coach he's 'figuring things out.' He told one coaching staff something different: 'I don't know who I am without him.'",
      ...
      },
      {
        ...
        eventText: "The new coach isn't sure what to do with {name}. He treats him like any other player, which is the problem. {name} spent five years being treated as someone particular. The shift is visible: his mechanics are intact but something in his approach has flattened. His old coach reached out to one coaching staff last week: 'Someone needs to remind him why he's different. I can't be that person anymore.'",
        choiceA: "Pass along what his old coach said — with permission — so he knows he's still being seen", choiceAOutcome: "The message from his old coach, carried by a program that cared enough to relay it, is the most credible affirmation available. He plays the next game differently.", choiceAWeights: W.bold_pos,
        ...
        choiceC: "Connect him with a player on {team}'s roster who navigated a coaching transition in high school", choiceCOutcome: "The peer story of how to perform when the person who believed in you first is gone lands in exactly the right place.", choiceCWeights: W.neutral_up,
      },
      {
        id: "coc_3",
        ...
        eventText: "{name} called his old coach before making his decision. The coach reached out to one program afterward — unprompted: 'He asked me which program would take care of him the way I did. I told him this one. I hope that's true.' There's a weight to that sentence that doesn't leave easily. It is also the clearest endorsement any mentor has given a program.",
    ...
    events: [
      {
        ...
        eventText: "{name} is the first person in his family to be recruited by a four-year college. His grandmother collects every letter — sorts them, keeps them in a shoebox under her bed, asks him to read them aloud to her in the evenings. She calls every school 'The University.' He shared these details with one coaching staff. He also shared that he asked his guidance counselor what 'office hours' meant and felt embarrassed about it for a week. He's brilliant. He's terrified. He needs someone to tell him both of those things are okay at the same time.",
        ...
        choiceB: "Connect him with a first-gen player on {team}'s roster who knows this exact feeling", choiceBOutcome: "The peer who has already crossed this distance and survived is the guide no coach can be. They talk for three hours.", choiceBWeights: W.safe_pos,
      ...
      },
      {
        ...
        eventText: "The acceptance letter came. {name} called one program before calling anyone in his family — before his parents even knew. He said: 'I got in. I'm the first one.' Then the line went quiet for almost ten seconds. When he came back he said: 'My dad's going to cry when I tell him. I know it.' He paused. 'I'm going to {team}. I just needed to tell someone who would understand what this actually is.'",
    ...
    events: [
      {
        ...
        eventText: "{name}'s agent initiated contact with three MLB teams before graduation. One responded with a preliminary slot value number. The agent shared it with the family. The family shared it with {name}. {name} shared it with one coaching staff — not to negotiate, but because the trust felt real and he was scared. He said: 'They want me to skip college entirely. Tell me it's not the right move.' He's asking for a case that may not be honest to make.",
      ...
      },
      {
        ...
        eventText: "An MLB scout visited {name}'s home — without the agent, with the family. {name} wasn't invited to the first part of the meeting. He watched from the doorway while a pro scout explained what a slot bonus could do for his parents. His mother called one program afterward, not to share the number — to ask a question: 'Is he ready? Truly ready? Because they're not going to wait for him to be.' She wasn't asking about his ability. She was asking about the rest of him.",
      ...
      },
      {
        ...
        eventText: "The deadline is in 48 hours. {name} has read every offer letter, every projection, every development timeline. His agent has called six times today. His family has stopped weighing in — they've made their peace with whatever he decides. At midnight, one program receives a message: 'I haven't made up my mind. I keep thinking about what was said. I think I know what I want. I just need to hear someone say it's okay to want it.'",
  ...
  small_town_hero: {
    ...
    events: [
      ...
      },
      {
        ...
        eventText: "{name} visited {team}'s campus and watched a practice for the first time. He's never seen players this good in person. Afterward, he sat in the parking lot for twenty minutes before calling his parents. He shared later: 'I thought I might not be good enough. Then I watched. And I thought — I might actually be better than most of those guys. I don't know how to feel about that.' He's never had competition that could tell him who he is. {team} might be the first place that can.",
...
export function generateStorylineEvent(
  ...
  teamName?: string,            // recruiting team's display name — replaces {team} in templates
): {
  storylineRecruitId: string;
  leagueId: string;
  season: number;
  ...
  const interpolate = (text: string) => {
    ...
    // event text never reveals which specific school is recruiting.
    let out = text
      .replace(/\{name\}/g, recruitName)
      .replace(/\{team\}/g, "the program");
