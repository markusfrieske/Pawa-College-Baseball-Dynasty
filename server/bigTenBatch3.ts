...
export const BIG_TEN_BATCH3_ROSTERS: Record<string, RealPlayer[]> = {
  ...
  "UCLA": [
    ...
    { firstName: "Maverek", lastName: "Russell", position: "2B", eligibility: "FR", homeState: "CA", hometown: "San Clemente", jerseyNumber: 28,
      hitForAvg: 35, power: 32, speed: 48, arm: 38, fielding: 42, errorResistance: 38, velocity: 0, control: 0, stamina: 0, stuff: 0,
      clutch: 32, vsLHP: 30, grit: 36, stealing: 44, running: 46, throwing: 50, recovery: 28, wRISP: 28, vsLefty: 25, poise: 28, heater: 0, agile: 38,
      abilities: ["Pinch Hitter"], potential: "B-", catcherAbility: null,
      throwHand: "R", batHand: "L",
      skinTone: "light", hairColor: "brown", hairStyle: "short",
      pitchFB: 0, pitch2S: 0, pitchSL: 0, pitchCB: 0, pitchCH: 0, pitchCT: 0, pitchSNK: 0, pitchSPL: 0, pitchFK: 0, pitchSFF: 0, pitchSHU: 0 },
