...
function getTeamsForConference(conferenceName: string) {
  const conferenceTeams: Record<string, Array<{ name: string; mascot: string; abbreviation: string; city: string; state: string; primaryColor: string; secondaryColor: string; prestige: number; stadium: number; facilities: number; collegeLife: number; marketing: number; academics: number; fanbasePassion: string; fanbaseType: string; enrollment: number; nilBudget: number }>> = {
    ...
    "WCC": [
      ...
      { name: "Saint Mary's", mascot: "Gaels", abbreviation: "SMC", city: "Moraga", state: "CA", primaryColor: "#06315b", secondaryColor: "#d20f29", prestige: 6, stadium: 4, facilities: 5, collegeLife: 7, marketing: 5, academics: 8, fanbasePassion: "C", fanbaseType: "Academic Elite", enrollment: 4000, nilBudget: 1200000 },
    ...
    "Big West": [
      ...
      { name: "Cal Poly", mascot: "Mustangs", abbreviation: "CPOL", city: "San Luis Obispo", state: "CA", primaryColor: "#154734", secondaryColor: "#bd8b13", prestige: 7, stadium: 5, facilities: 6, collegeLife: 8, marketing: 5, academics: 7, fanbasePassion: "B", fanbaseType: "Balanced", enrollment: 22000, nilBudget: 1500000 },
