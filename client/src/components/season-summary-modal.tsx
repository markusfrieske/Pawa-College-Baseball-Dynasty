...
interface SeasonSummaryData {
  ...
  standings: { name: string; abbreviation: string; primaryColor: string; wins: number; losses: number }[];
                  ...
                  <RetroCard data-testid="summary-user-team">
                    ...
                    <RetroCardContent>
                      <div className="flex items-center gap-3 mb-3">
                        <TeamBadge abbreviation={data.userTeam.abbreviation} primaryColor={data.userTeam.primaryColor} size="md" />
                        <div>
                  ...
                  <RetroCardContent>
                    {data.cwsChampion ? (
                      <div className="flex items-center gap-3">
                        <TeamBadge abbreviation={data.cwsChampion.abbreviation} primaryColor={data.cwsChampion.primaryColor} size="md" />
                        <div>
                  ...
                  <RetroCardContent className="space-y-2">
                    {data.standings.slice(0, 5).map((team, i) => (
                      <div key={i} className="flex items-center gap-3 text-sm" data-testid={`standing-${i}`}>
                        ...
                        <TeamBadge abbreviation={team.abbreviation} primaryColor={team.primaryColor} size="sm" />
