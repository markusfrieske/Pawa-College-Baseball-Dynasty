...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "varsity-tabs-list inline-flex items-center justify-start gap-1 rounded-lg border border-border bg-background/40 p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
