...
export function DevelopmentTab({
    ...
    return (
      <RetroCard>
        <div className="text-center py-16 text-muted-foreground">
          ...
          <p className="text-xs font-semibold mb-2">NO DEVELOPMENT DATA YET</p>
  ...
  return (
    <div className="space-y-4">
      ...
      <RetroCard>
        <div className="p-4">
          <h3 className="text-gold text-xs mb-4">OFFSEASON DEVELOPMENT SUMMARY</h3>
          <div className="grid grid-cols-3 gap-4 mb-4">
            <div className="text-center p-3 rounded-lg bg-card/60 border border-border">
              ...
              <p className="text-xs font-semibold text-muted-foreground mt-1">AVG OVR CHANGE</p>
            </div>
            <div className="text-center p-3 rounded-lg bg-green-900/10 border border-green-800/30">
              ...
              <p className="text-xs font-semibold text-muted-foreground mt-1">IMPROVED</p>
            </div>
            <div className="text-center p-3 rounded-lg bg-red-900/10 border border-red-800/30">
              ...
              <p className="text-xs font-semibold text-muted-foreground mt-1">REGRESSED</p>
            </div>
          </div>
          ...
          {breakouts.length > 0 && (
            <div className="border-t border-border pt-3">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h4 className="text-gold text-xs">BREAKOUT PLAYERS</h4>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="text-left">
                        ...
                        <p className="text-xs font-semibold text-green-400">+{delta} OVR{starChanged ? ` · ${prevStar}★→${p.starRating}★` : ""}</p>
                      </div>
                    </button>
                  );
                })}
      ...
      <RetroCard>
        <div className="px-4 py-3 border-b border-border">
          <h3 className="text-gold text-xs">PLAYER DEVELOPMENT REPORT</h3>
        </div>
              ...
              >
                    ...
                    <div className="flex flex-wrap items-center gap-x-1.5 gap-y-0.5 mt-1" data-testid={`text-dev-attrs-${p.id}`}>
                      {topAttrs.map((attr, i) => (
                        <span key={attr.label} className="flex items-center gap-0.5">
                          ...
                          <span className={`text-xs font-semibold ${attr.delta > 0 ? "text-green-400" : "text-red-400"}`}>
                ...
                <div className="text-right flex-shrink-0 space-y-0.5">
                  <div className="flex items-center gap-2 justify-end">
                    ...
                    <span
                      className={`text-xs font-semibold font-bold w-8 text-right ${
                  ...
                  {starChanged && (
                    <p className="text-xs text-gold">{prevStar}★ → {p.starRating}★</p>
                  )}
                </div>
              </button>
            );
