...
export const coaches = pgTable("coaches", {
  ...
  offenseSkill: integer("offense_skill").notNull().default(1),
  defenseSkill: integer("defense_skill").notNull().default(1),
  trainingSkill: integer("training_skill").notNull().default(1),
  recruitingSkill: integer("recruiting_skill").notNull().default(1),
...
export const players = pgTable("players", {
  ...
  potential: text("potential").notNull().default("C"),
