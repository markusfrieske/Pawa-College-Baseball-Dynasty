...
export const players = pgTable("players", {
  ...
  trajectory: integer("trajectory").notNull().default(2),
...
export const recruits = pgTable("recruits", {
  ...
  // For TRANSFER recruits only: prestige of the player's origin program at portal entry time.
  // Used to compute the prestige band (originPrestige ± 2) for interest modifiers.
  originPrestige: integer("origin_prestige"),
...
export const recruitingInterests = pgTable("recruiting_interests", {
  ...
  uniqueIndex("uq_recruiting_interests_recruit_team").on(t.recruitId, t.teamId),
