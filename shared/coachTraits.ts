...
export const PHILOSOPHY_DESCRIPTIONS: Record<string, string> = {
  "Recruit for the Long Term":   "+10% email/phone bonus with early-pipeline recruits (stages 1–3)",
  "Build Team Chemistry":        "+12% campus visit interest gain",
  "Play Small Ball":             "+4% flat bonus on all recruiting actions",
  "Win Now":                     "+14% scholarship offer interest gain",
  "Elite Program Standards":     "+12% campus visit conversion rate",
  "Build a National Brand":      "+7% bonus on all actions targeting out-of-state recruits",
  "Player Development First":    "+14% email/phone with development-minded recruits; +6% with all others",
  "Positive Culture":            "+12% campus visit gain; +4% email/phone bonus",
  "Trust the Process":           "+7% email/phone/offer when recruit is already interested (stage 3+)",
  ...
  "Exploit Every Matchup":       "+5% email/phone bonus from system-fit insights",
  "Play the Right Way":          "+14% bonus on all actions with same-state recruits; +7% same region",
  "Defense and Pitching":        "+12% phone call bonus with pitching recruits",
  "Earn Everything":             "+7% head coach visit and campus visit effectiveness",
  "Scouting Advantage":          "+8% email/phone bonus from deeper scouting intel",
  "Find Hidden Gems":            "+12% email/phone bonus targeting 1–2★ recruits",
  "Build Through Recruiting":    "+5% email/phone bonus across the entire board",
  "Academic Excellence":         "+14% bonus on all actions with academics-priority recruits",
  "Graduation Rate Matters":     "+12% campus visit interest gain",
  "Character Counts":            "+8% email/phone bonus with academics-focused recruits",
