  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        gold: "hsl(var(--primary) / <alpha-value>)",
        "gold-dark": "hsl(41 45% 50% / <alpha-value>)",
        forest: {
          DEFAULT: "hsl(var(--sidebar) / <alpha-value>)",
          light: "hsl(var(--card) / <alpha-value>)",
      ...
      keyframes: {
        ...
        "pulse-glow": {
          ...
          "50%": { boxShadow: "0 0 16px 4px rgba(255, 215, 0, 0.6)" },
        },
      },
      animation: {
